...
const SAMPLE_KEYS = [
    ...
    {
        id: 'key_b12c8e4f6a9d21',
        description: 'Mobile App Prod',
        sourceCidr: '0.0.0.0/0',
        domain: 'app',
        lastUsed: 'Jul 27, 3:12 PM',
        lastUsedIp: '104.28.14.6',
        active: true,
    },
    {
        id: 'key_c48f01a9de7325',
        description: 'Hub Sync Service',
        sourceCidr: '10.0.0.0/8',
        domain: 'hub',
        lastUsed: 'Jul 26, 9:45 AM',
        lastUsedIp: '10.0.4.22',
        active: true,
    },
    {
        id: 'key_d75a3e6f120b48',
        description: 'Admin Dashboard',
        sourceCidr: '192.168.1.0/24',
        domain: 'admin',
        lastUsed: 'Jul 20, 11:30 AM',
        lastUsedIp: '192.168.1.14',
        active: true,
    },
    {
        id: 'key_e93b7c2d40f156',
        description: 'Client Portal Widget',
        sourceCidr: '0.0.0.0/0',
        domain: 'portal',
        lastUsed: '',
        lastUsedIp: '',
    ...
    {
        id: 'key_f10d84a6b3e972',
        description: 'CI/CD Deploy Bot',
        sourceCidr: '203.0.113.0/24',
        domain: 'app',
        lastUsed: 'Jul 15, 6:00 AM',
        lastUsedIp: '203.0.113.9',
        active: true,
    },
    {
        id: 'key_a2e659f7c81034',
        description: 'Analytics Ingest',
        sourceCidr: '172.16.0.0/12',
        domain: 'hub',
        lastUsed: 'Jul 10, 4:22 PM',
        lastUsedIp: '172.16.2.11',
        active: false,
    },
    {
        id: 'key_b76f2a0d5e9c43',
        description: 'Legacy Integration',
        sourceCidr: '0.0.0.0/0',
        domain: 'admin',
        lastUsed: 'Jun 30, 8:05 AM',
        lastUsedIp: '198.51.100.42',
        active: false,
    },
];
