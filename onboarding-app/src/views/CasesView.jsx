    ...
    return (
        <div className="cases-view">
            ...
            <div className="hubs-table">
                ...
                {visibleCases.map(c => (
                    <div key={c.id} className="cases-table-row">
                        ...
                        <span data-label="Action">
                            <div className="cases-action-group">
                                <button className="cases-icon-btn edit" data-tooltip="Edit Case" onClick={() => setEditingCase(c)}>
                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                </button>
                                <button className="cases-icon-btn delete" data-tooltip="Delete Case" onClick={() => setDeleteTarget(c)}>
                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                                </button>
                                {c.status === 'Closed' ? (
                                    <button className="cases-icon-btn reopen" data-tooltip="Open Case" onClick={() => reopenCase(c)}>
                                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 8 4 4-4 4"/></svg>
                                    </button>
                                ) : (
                                    <button className="cases-icon-btn close" data-tooltip="Close Case" onClick={() => setCloseTarget(c)}>
