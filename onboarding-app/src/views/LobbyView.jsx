...
const CASE_NAV = [
    ...
    { label: 'Overview', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> },
];
                        ...
                        <main className="case-main">
                            ...
                            <div className="case-content-body">
                                {activeCaseNav === 'Feed' ? (
                                    ...
                                    <ConvoView embedded />
                                ) : activeCaseNav === 'Overview' ? (
                                    <OverviewView embedded caseTitle={selectedCase.title} caseUpdated={selectedCase.updated} members={selectedCase.members} />
                                ) : (
